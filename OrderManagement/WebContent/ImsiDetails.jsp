...
<div id="wrap">
		...
		<div id="main">				
			...
			<form id="imsiForm" action="ImsiDetailsController" method="get">
		<center>
		<table width=100%>
		<input type="hidden" name="checkPage" value="imsiDetails">
			<tr>
		...
		<table>
			<tr>
				<td><input type="button" class="button" value="Submit" onclick="checkImsi(15)"></input></td>
				<td>&nbsp &nbsp &nbsp<td />
				<td><input type="button" class="button"  value="Reset" onclick="resetValues()"></input></td>
			</tr>
		</table>
		<p style="color: red">
		${errorMessage}</p>
